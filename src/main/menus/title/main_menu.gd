...
# References
const SERVER_MENU_PATH: String = 'res://src/main/menus/multiplayer/ServerMenu.tscn'
const LOCAL_MULTI_PATH: String = 'res://src/main/menus/local_game/LocalMultiplayerScreen.tscn'
